...
var ViewProcesoPage = /** @class */ (function () {
    function ViewProcesoPage(navCtrl, params, alertCtrl, viewCtrl) {
    ...
    return ViewProcesoPage;
}());
export { ViewProcesoPage };
//# sourceMappingURL=view-proceso.js.map