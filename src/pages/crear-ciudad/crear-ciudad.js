...
var CrearCiudadPage = /** @class */ (function () {
    function CrearCiudadPage(navCtrl, navParams, _crud) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this._crud = _crud;
    }
    CrearCiudadPage.prototype.crearCiudad = function (ciudad, estado) {
        var nuevoEstado;
        if (estado) {
            nuevoEstado = 'ACTIVO';
        }
...
export { CrearCiudadPage };
//# sourceMappingURL=crear-ciudad.js.map