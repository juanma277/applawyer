...
export class ReporTipoPage {
  ...
  constructor(public navCtrl: NavController, 
  	...
  	let loader = this.loadingCtrl.create({
    	...
    	this._cpp.procesosTipo(this.id).then(res=>{
    		this.data = this._cpp.procesosPorTipo;

    		for( let lista of this.data){
    			this.cantidadProcesos.push(lista['cantidad']);
    			this.procesosPorTipo.push(lista['tipo']);
    		}
  ...
  //Chart Labels
  public barChartLabels:string[] = this.procesosPorTipo;
